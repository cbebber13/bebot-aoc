...
*  USA
*
* File last changed at $LastChangedDate: 2008-05-22 16:21:13 +0100 (Thu, 22 May 2008) $
* Revision: $Id: Time.php 1592 2008-05-22 15:21:13Z alreadythere $
*/
...
{ // Start Class
	...
	*/
	...
	{ // Start function show_time()
		...
		$output .= "##darkorange##Happy Halloween!!##end##";
		if (gmdate("n") == 12 && gmdate("j") == 25) // OMG Christmas!
		$output .= "##red##Merry##end## ##lime##Christmas##end## ##red##from##end## ##lime##Santa##end## ##red##Conan!##end##";
		return $output;
