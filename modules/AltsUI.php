...
*  USA
*
* File last changed at $LastChangedDate: 2008-07-05 14:04:17 +0100 (Sat, 05 Jul 2008) $
* Revision: $Id: AltsUI.php 1668 2008-07-05 13:04:17Z temar $
*/
...
class Alts extends BaseActiveModule
{
	...
	*/
	function __construct(&$bot)
	{
		...
		$this -> register_command("all", "alts", "GUEST");
	...
	*/
	function add_alt($name, $alt, $admin = 0)
	{
		...
		$query = "SELECT main FROM #___alts WHERE main='$alt' OR alt='$alt'";
