...
* Revision: $Id: _ExampleModule.php 1554 2008-05-11 23:15:50Z temar $
*/
...
*/
		$this -> bot -> core("settings") -> create('module', 'setting', 'default', 'description of setting', 'option1;option2;option3');
...
*/
		$this -> bot -> core("prefs") -> create("module", "name", "description", "default", "option1;option2", "access");
