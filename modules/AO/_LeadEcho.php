...
* Revision: $Id: LeadEcho.php 1554 2008-05-11 23:15:50Z temar $
*/
...
class LeadEcho extends BaseActiveModule
{
	function __construct(&$bot)
	{
		...
		$this -> bot -> core("colors") -> define_scheme("leader_echo", "spam", "yellow");
	...
	*/
	...
	function set_leader($caller, $leadername, $repeatstring)
	{
		...
		if ($this -> bot -> core("settings") -> get("Leader", "Name") != '' &&
		($this -> bot -> core("security") -> get_access_level($caller) <
		$this -> bot -> core("security") -> get_access_level($this -> bot -> core("settings") -> get("Leader", "Name"))))
		{
			return "##error##" . $caller . ", you can't take lead from "
				. $this -> bot -> core("settings") -> get("Leader", "Name") . "##end##";
		}
