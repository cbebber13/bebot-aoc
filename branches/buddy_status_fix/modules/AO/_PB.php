...
*  USA
*
* File last changed at $LastChangedDate: 2008-05-24 03:19:50 +0100 (Sat, 24 May 2008) $
* Revision: $Id: PB.php 1620 2008-05-24 02:19:50Z temar $
*/
...
class PB extends BaseActiveModule
{
	...
	private $units = array(
		'adv' => array('infantry', 'artillery', 'support'),
		'agent' => array('artillery'),
		'crat' => array('control', 'extermination'),
		'doc' => array('support'),
		'enf' => array('infantry'),
		'eng' => array('control'),
		'fixer' => array('artillery', 'support'),
		'keeper' => array('infantry', 'support'),
		'ma'=>array('infantry', 'support'),
		'mp'=>array('control', 'extermination', 'support'),
		'nt'=>array('extermination'),
		'sol'=>array('artillery'),
		'trader'=>array('artillery', 'control', 'support'));
