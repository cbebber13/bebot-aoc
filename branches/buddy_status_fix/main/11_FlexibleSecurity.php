...
class FlexibleSecurity_Core extends BasePassiveModule
{
	...
	{
		if($this -> bot -> core("settings") -> exists("FlexibleSecurity", "SchemaVersion"))
		{
			$this -> bot -> db -> set_version("security_flexible",
			$this -> bot -> core("settings") -> get("FlexibleSecurity", "SchemaVersion"));
			$this -> bot -> core("settings") -> del("FlexibleSecurity", "SchemaVersion");
		}
